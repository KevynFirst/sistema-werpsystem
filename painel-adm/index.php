...
$nivel_est = @count($res);
if ($nivel_est > 0) {
    $cor_menu = "text-danger";
} else {
    $cor_menu = "";
}
$cor_contas = "text-warning";
$cor_rel = "text-info";
$cor_compras = "text-primary";
$cor_mov = "text-success";
?>
...
<head>
    ...
    <meta name="author" content="Kevyn B Ladislau">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Funcionários</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Clientes</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu6 ?>">Tipo Serviços</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities1"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Novo Orçamento</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu9?>">Aprovação Orçamentos</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu10?>">Serviços</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities2"
                    ...
                    <i class="fas fa-coins <?php echo $cor_contas;?>"></i>
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities2"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu11 ?>">Contas À Pagar</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu12?>">Contas À Receber</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu16?>">Vales</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?pag=<?php echo $menu14 ?>">
                    <i class="fas fa-fw fa-cart-plus <?php echo $cor_compras;?>"></i>
                    <span class="">Compras</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="index.php?pag=<?php echo $menu15 ?>">
                <i class="fas fa-book-open <?php echo $cor_mov;?>"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRel" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-file  <?php echo $cor_rel;?>"></i>
                    <span>Relatórios</span>
                </a>
                <div id="collapseRel" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="" data-toggle="modal" data-target="#ModalRelServicos">Serviços Concluídos</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <img class="mt-2" src="../img/logoRPsystem1.png" width="150">
    ...
    <!-- scripts Mask <script src="../js/mascaras.js"></script>-->
